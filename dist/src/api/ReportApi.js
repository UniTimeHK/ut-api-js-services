...
var ReportApi = (function () {
    ...
    /**
         ...
         * @param input
         */
    ReportApi.prototype.reportActivity = /**
         *
         * @param input
         */
    ...
    /**
         ...
         * @param input
         */
    ReportApi.prototype.reportActivityWithHttpInfo = /**
         *
         *
         * @param input
         */
    function (input, extraHttpRequestParams) {
        var path = this.basePath + '/api/services/app/Report/ReportActivity';
    ...
    ReportApi.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    ReportApi.ctorParameters = function () { return [
        { type: Http, },
